      ...
      <div className={classes.featCont}>
        <div className={classes.feat}>
          <div className={classes.featTitle}>
            Modules infrastructure that makes Comdex ecosystem more powerful.
          </div>
              ...
              <div className={classes.list}>
                ...
                <div>
                  ...
                  <div className="property-text">
                    The modular infrastructure makes the Comdex ecosystem more
                    powerful.
                  </div>
                </div>
              </div>
                ...
                <div className="list2Item">
                  ...
                  <div>
                    ...
                    <div className="property-text" style={{ marginBottom: 25 }}>
                      Use webauthn to sign transactions. The Comdex and passkeys
